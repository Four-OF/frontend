...
const ForgotPassword = () => {
    const [showSection, setShowSection] = useState('forgot-password')
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setShowSection('forgot-password-email-sent')
        } catch (err) {
                ...
                return (
                    <>
                        ...
                        <div className="w-full max-w-sm space-y-5 mx-auto flex-grow flex flex-col justify-center">
                            ...
                            <p>Enter your email and we will send instruction on how to reset your password.</p>
